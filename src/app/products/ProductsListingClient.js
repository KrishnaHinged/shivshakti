          ...
          <div className="relative z-20 max-w-[1300px] flex flex-col gap-6">
            ...
            {/* <div className="relative max-w-md w-full mt-4">
              ...
              <input
                ...
                placeholder="Search catalog, brands, components..."
                suppressHydrationWarning
                className="w-full bg-white/10 backdrop-blur-md border border-white/10 rounded-full pl-12 pr-10 py-3.5 text-white text-[0.95rem] outline-none transition-all duration-300 focus:border-brand-orange focus:bg-white/15 focus:ring-1 focus:ring-brand-orange/30 placeholder:text-slate-400"
              />
              {searchQuery && (
                <button
