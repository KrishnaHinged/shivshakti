...
export default async function BlogListingPage({ searchParams }) {
  ...
  return (
    <div className="bg-[#040814] text-white min-h-screen flex flex-col font-sans select-none overflow-x-hidden">
      ...
      {/* Main spacer */}
      <main className="flex-1 max-w-[1300px] w-full mx-auto px-6 lg:px-12 pt-36 pb-24">
        
        {/* Banner Section */}
        <div className="text-center max-w-[800px] mx-auto mb-16">
          <span className="text-brand-orange text-[0.82rem] font-bold uppercase tracking-[0.2em] bg-brand-orange/10 border border-brand-orange/20 px-4 py-1.5 rounded-full inline-block mb-4">
            Insights & Engineering Updates
          </span>
          <h1 className="text-4xl md:text-5xl font-black text-white leading-tight">
            Shivshakti Technical Blog
          </h1>
          <p className="text-text-secondary text-sm md:text-base mt-4 max-w-[600px] mx-auto">
