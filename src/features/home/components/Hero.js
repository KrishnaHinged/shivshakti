...
/**
 * Hero component displaying the landing page headline, background, and CTA link.
 * @param {object} props
...
export function Hero({ settings }) {
  return (
    <div className="w-full px-4 lg:px-8 pt-24 lg:pt-28 pb-4 bg-transparent">
      ...
      <div
        id="home"
        className="relative w-full rounded-[2.5rem] lg:rounded-[3.5rem] overflow-hidden bg-neutral-950 min-h-[70vh] lg:min-h-[80vh] flex flex-col items-center justify-center text-center p-8 lg:p-16 border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.3)]"
      >
