...
export const QuotationMarkIcon = (props) => (
...
export const LightningIcon = ({ strokeWidth = 1.8, ...props }) => (
  <svg fill="none" stroke="currentColor" strokeWidth={strokeWidth} viewBox="0 0 24 24" {...props}>
...
export const VerifiedBadgeIcon = (props) => (
