...
/**
 * Connect to MongoDB database and initialize backend queue worker.
...
async function dbConnect() {
  ...
  if (!cached.promise) {
    const opts = {
      ...
      serverSelectionTimeoutMS: 5000, // Fail fast if MongoDB connection fails to prevent page render freeze
    };
